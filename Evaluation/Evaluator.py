...
class Evaluator(object):
    ...
    def evaluateRecommender(self, recommender_object, block_size=None):
        """
        ...
        results_dict = self._run_evaluation_on_selected_users(recommender_object, self.users_to_evaluate, block_size)
